function validateSignupForm() {
    ...
    //if (name == "") {
    //    document.getElementById("fNameMistake").innerHTML = "Please enter name";
    //    return false;
    //} else {
    //    return true;
    //}
...
function checkConfirmPassword() {
    ...
    if (checkPassword() && password != confPassword) {
        ...
        document.getElementById("fConfPWD").style.backgroundColor = "var(--bgContainerColor)";
...
function checkTerms() {
    if (document.getElementById("fTerms").checked) {
        ...
        document.getElementById("fTermsMistake").style.color = "var(--headerSecondaryColor)";
        return false;
    }
}
